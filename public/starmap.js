...
var $author$project$Traveller$hexAddressLabel = F4(
	function (x, y, size, hexAddress) {
		return (size <= 15) ? $elm$svg$Svg$text('') : A2(
			$elm$svg$Svg$text_,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(
			...
			_List_fromArray(
				[
					...
					if (showStar) {
						...
						return A4($author$project$Traveller$hexAddressLabel, vox, voy, size, hexAddress);
					}
				}(),
					showStar ? A2(
					$elm$svg$Svg$g,
					...
					_List_fromArray(
						[
							A4($author$project$Traveller$hexAddressLabel, vox, voy, size, hexAddress),
							(size <= 15) ? $elm$svg$Svg$text('') : A2(
							$elm$svg$Svg$text_,
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$x(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					hexColour),
					A4($author$project$Traveller$hexAddressLabel, x, y, size, hexAddress),
					childSvg
				]));
	});
