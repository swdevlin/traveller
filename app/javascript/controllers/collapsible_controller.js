...
export default class extends Controller {
  ...
  static values = { collapseClass: { type: String, default: '' } }

  toggle() {
    if (this.collapseClassValue) {
      const isCollapsed = this.contentTarget.classList.toggle(this.collapseClassValue)
