...
class TechLevelsControllerTest < AuthenticatedIntegrationTest
  ...
  test 'should create tech_level' do
    assert_difference('TechLevel.count') do
      post tech_levels_url, params: { tech_level: { air: @tech_level.air, code: 3, electronics: @tech_level.electronics, energy: @tech_level.energy, environmental: @tech_level.environmental, heavy_military: @tech_level.heavy_military, land: @tech_level.land, manufacturing: @tech_level.manufacturing, medical: @tech_level.medical, notes: @tech_level.notes, personal_military: @tech_level.personal_military, environmental: @tech_level.environmental, sea: @tech_level.sea, space: @tech_level.space } }
    end
  ...
  test 'should update tech_level' do
    patch tech_level_url(@tech_level), params: { tech_level: { air: @tech_level.air, code: @tech_level.code, electronics: @tech_level.electronics, energy: @tech_level.energy, environmental: @tech_level.environmental, heavy_military: @tech_level.heavy_military, land: @tech_level.land, manufacturing: @tech_level.manufacturing, medical: @tech_level.medical,  environmental: @tech_level.environmental, notes: @tech_level.notes, personal_military: @tech_level.personal_military, sea: @tech_level.sea, space: @tech_level.space } }
