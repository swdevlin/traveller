...
class Api::SolarSystemControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test 'returns single star system by sector and hex coordinates' do
    get api_solarsystem_url(sx: 1, sy: 1, hx: 1, hy: 1), as: :json
  ...
  test 'returns 404 for non-existent hex' do
    get api_solarsystem_url(sx: 1, sy: 1, hx: 99, hy: 99), as: :json
    assert_response :not_found
  end

  test 'returns 400 when parameters missing' do
    get api_solarsystem_url, as: :json
